...
$monitors = dbFetchAll( "select * from Monitors order by Id asc" );
...
<!--	<div style="float:left;"><a href="http://www.stagecoach-wireless.com"><img src="skins/touchscreen/graphics/logo.png" height="50" alt="logo" border="0"/></a></div>-->
	<ul>
